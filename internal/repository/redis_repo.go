...
type IRedisRepository interface {
	...
	Set(ctx context.Context, key string, value any, expiration time.Duration) error // Phương thức này cho phép lưu trữ một cặp key-value trong Redis với thời gian hết hạn (expiration) được chỉ định. Nếu expiration là 0, key sẽ tồn tại mãi mãi cho đến khi bị xóa.
